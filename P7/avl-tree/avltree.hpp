...
public:
    ...
    void compute_height()
    {
        if (!has_left() && !has_right()){
            ...
            height_ = 1 + right() -> height();
        }
        else if (has_left() && !has_right()){
            height_ = 1 + left() -> height();
        }
...
protected:
   ...
   */
    void rotate_left(typename AVLTNode<T>::Ref& child,
                    ...
                    typename AVLTNode<T>::Ref& grand_parent, bool double_rotate = false)
    {
        ...
        if (grand_parent == nullptr){
            ...
            if (double_rotate == true){
                grand_parent -> set_right(child);
            }
            else{
                grand_parent -> set_left(child);
            }
        }
        ...
        while(parent_)
        {
            ...
            if (bf < -1)
            {
                ...
                else
                {
                    ...
                    rotate_right(n3, n2, n1, true);
                    rotate_left(n3, n1, grand_parent);
                }
            }
            else if (bf > 1)
            {              
                ...
                else
                {
                    ...
                    rotate_left(n3, n2, n1, true);
                    rotate_right(n3, n1, grand_parent);
   ...
   */
    bool is_a_balanced_subtree(typename AVLTNode<T>::Ref const& node) const
    {
        ...
        if (node -> has_right()){
            right = is_a_balanced_subtree(node -> right());
        }
        if (node -> has_left()){
            left = is_a_balanced_subtree(node -> left());
        }
